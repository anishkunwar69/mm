    ...
    >
      ...
      <div 
        className={`absolute inset-0 pointer-events-none flex items-center justify-center font-bangers text-[60vh] text-spider-white leading-none overflow-hidden select-none z-0 transition-opacity duration-1000 ease-out ${
          isVisible ? "opacity-[0.05]" : "opacity-0"
        }`}
      >
        VS
      </div>
      ...
      {/* CENTER CONTENT */}
      <div className="relative z-20 w-full max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 lg:gap-32 mt-10 md:mt-0">

        {/* LEFT COLUMN: THE HERO */}
        <div 
          className={`flex flex-col items-center md:items-end text-center md:text-right h-full transition-all duration-1000 ease-out delay-300 ${
            isVisible ? "translate-x-0 opacity-100" : "-translate-x-8 opacity-0"
          }`}
        >
          <div className="space-y-8 flex-1 flex flex-col items-center md:items-end">
            <div className="space-y-[-10px]">
              <h2
                className="font-bangers tracking-wider text-spider-white leading-none"
                style={{ fontSize: "clamp(2.5rem, 9vw, 6rem)" }}
              >
                THE HERO
              </h2>
              <h3
                className="font-bangers tracking-wide text-spider-black leading-none opacity-80"
                style={{ fontSize: "clamp(1.75rem, 7.5vw, 4.375rem)" }}
              >
                SPIDER-MAN
              </h3>
            </div>

            <div className="flex flex-col items-center md:items-end space-y-3 font-mono text-sm md:text-base tracking-widest uppercase text-spider-black">
              ...
              <div className="mt-6 pt-4 border-t border-spider-black/20 w-full max-w-[200px] flex justify-center md:justify-end">
                <span className="text-xs text-spider-black/50 tracking-[0.2em] font-bold">THREAT / MULTIVERSE</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div 
          className={`flex flex-col items-center md:items-start text-center md:text-left h-full transition-all duration-1000 ease-out delay-300 ${
            isVisible ? "translate-x-0 opacity-100" : "translate-x-8 opacity-0"
          }`}
        >
          <div className="space-y-8 flex-1 flex flex-col items-center md:items-start">
            <div className="space-y-[-10px]">
              <h2
                className="font-bangers tracking-wider text-spider-white leading-none"
                style={{ fontSize: "clamp(2.5rem, 9vw, 6rem)" }}
            ...
            <div className="flex flex-col items-center md:items-start space-y-3 font-mono text-sm md:text-base tracking-widest uppercase text-spider-black">
              ...
              <div className="mt-6 pt-4 border-t border-spider-black/20 w-full max-w-[200px] flex justify-center md:justify-start">
                <span className="text-xs text-spider-black/50 tracking-[0.2em] font-bold">STATUS / ACTIVE</span>
              </div>
            </div>
          </div>
        </div>
