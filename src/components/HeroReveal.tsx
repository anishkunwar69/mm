...
───────────────────────────────────────────────────────────────────── */
const SpiderMenuIcon = ({ open }: { open: boolean }) => (
...
───────────────────────────────────────────────────────────────────── */
const WebCorner = ({ position }: { position: "tl" | "br" }) => {
...
export default function HeroReveal() {
  ...
  // Close menu on resize past sm breakpoint
  useEffect(() => {
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        >
          ...
          >
            ...
            >
              <a href="#" className={desktopNavLink}>Manifesto</a>
              <a href="#" className={`${desktopNavLink} relative group`}>
                Origins
                <span className="absolute -bottom-2 left-0 w-0 h-0.5 bg-spider-yellow transition-all group-hover:w-full" />
              </a>
              <a href="#" className={desktopNavLink}>Suit Tech</a>
            </nav>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-end gap-3 sm:gap-4 w-full">
            ...
            >
              ...
              <p className="uppercase leading-relaxed tracking-wide text-spider-black" style={{ fontSize: "clamp(0.6rem, 1.5vw, 0.75rem)" }}>
                Subject exhibits advanced bio-electric striking capabilities.
                Current location tracking active in Brooklyn.
              </p>
        ...
        {/* ═══════════════════════════════════════════════════════════════════
            MOBILE MENU PANEL — slides down from under the header.
            z-40 sits above images (z-10/20) and UI overlay (z-30) while
            still being inside the section's overflow-hidden clip.
        ═══════════════════════════════════════════════════════════════════ */}
        {/* Click-outside backdrop — covers the rest of the screen beneath the panel */}
        {menuOpen && (
          <div
        ...
        >
          ...
          >
            ...
            {/* Halftone dot layer — subtle, matches site-wide pattern */}
            <div
            ...
            {/* Faint web watermark — bottom-right corner */}
            <WebWatermark />
            ...
            {/* Thin red accent stripe down the left edge */}
            ...
            <nav className="relative flex flex-col gap-0 z-10">
              {[
                ...
                >
                  ...
                  {/* Animated arrow-thread on hover */}
